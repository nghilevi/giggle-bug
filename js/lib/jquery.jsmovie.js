 ...
 **/
var outroLoaded = false;
var levelTwoFramesJs;
(function($) {
    var i = 0;
    var settings = {
        images : [],
    ...
    function animatePreloader(){
        if(this.data("loadStatus") != "loaded" && $(this).data("settings").showPreLoader){
            ...
            var self = this;
            // Loading for video intro
            /*
            var loadingInterval = setInterval(function() {
                // console.log(self.data('loadStatus'));
                ...
                $('#video video').bind("ended", function(){ 
                    if(self.data("loadStatus") == "loaded"){
                        ...
                        //$('#container').append("<div class='loading-animation' />");
            ...
            */
            ...
            var loadingInterval = setInterval(function() {
                ...
                var tmp;
                try {
                    if (localStorage.getItem("firstCache")) 
                        tmp = 1000;
                    else
                        tmp = 20000;
                }
                ...
                if(self.data("loadStatus") == "loaded"){
                    ...
                    //$('.loading-animation').remove()
                    i++;
                    // var j = $('.l1').length + $('.face-motion-level-1').children().length - 1;
                    
                    //console.log($('.face-motion-level-1').children().length);
                    // console.log($('#container').children().length);
                    // console.log(i);
                    ...
                    if (i == 16) {
                        setTimeout(function() {
                            ...
                            $('#start-game').one("click", function() {
                                ...
                                // $('#container').css('background-image', 'url(img/intro.gif)');
                                // $('#container').prepend('<img id="introImg" src="img/pressStart.jpg">');
                                $(this).find('img').attr('src', 'img/intro.gif');
                                // lowLag.play('intro');
                                createjs.Sound.play("intro");
                                // $('#intro-frames').jsMovie("play");
                                setTimeout(function() {
                                    // $('#introImg').hide();
                                    // $(this).children().hide();
                                    // $(this).hide();
                                    // $('#container').css('background', "url(img/BACKGROUNDS/Ground.png), url(img/BACKGROUNDS/sky.png)");
